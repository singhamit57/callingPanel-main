...
$que = "SELECT COUNT(LeadID) as 'Count' FROM LeadResponse WHERE AddStamp >= '<Date> 00:00:00' AND AddStamp <= '<Date> 23:59:59';";
...
$que = "SELECT COUNT(FullName) as 'Count' FROM LeadsDataBase WHERE LastResponse <> 'NA' AND LastPriority LIKE('%Lead') and RespStamp >= '<Date> 00:00:00' AND RespStamp <= '<Date> 23:59:59';";
...
$que = "SELECT COUNT(FullName) as 'Count' FROM LeadsDataBase WHERE LastResponse <> 'NA' AND LastLeadResult = 'Successfull' and RespStamp >= '<Date> 00:00:00' AND RespStamp <= '<Date> 23:59:59';";
...
$Que = "SELECT COUNT(FullName) as 'Count' FROM LeadsDataBase WHERE LastResponse = 'NA'; ";
$AvailableLead = getcardcont($Que);

$Que = "SELECT COUNT(FullName) as 'Count' FROM LeadsDataBase WHERE FullName <> '' ";
...
$totalValue = 0;
$Que= "SELECT DISTINCT LastResponse , COUNT(FullName) as 'Count' FROM LeadsDataBase WHERE LastResponse <> 'NA' GROUP BY LastResponse";
$result =mysqli_query($conn,$Que);
