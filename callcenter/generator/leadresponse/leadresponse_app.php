...
if($MeetingDate == date('Y-m-d') or $ShowMeetDate == "Select Date"){
...
if($DataType == 'callhistory' or $DataType == 'leaddata'){
    ...
    $Saveresponse = "INSERT  INTO LeadResponse ( AddStamp, CompanyID, LeadID, Userid, Department, Response, IntDate, Priority, LeadResult, Remark, CallDuration,CallRecordID, DataCode, RespCount, LastUpdateStamp, LastUpdateBy ) VALUE ( '$Timestamp', '$CompID', '$TableID', '$UserID', '$SelectedDepart', '$SelectedResponse', '$MeetingDate', '$Priority', '$FinalResult', '$Remark', '$callDuartion','$CallRecordingID', '$DataCode', '$RespCount', '$Timestamp', '$UserID' );";
